...
def result():
    ...
    messagebox.showinfo("Result", "Skin Lesion Classsfication Result : "+str(out))
    messagebox.showinfo("Stage", "Skin Stage : " + str(affect))
...
def main_account_screen():
    ...
    main_screen.title("Skin Lesion Classification")

    Label(text="Skin  Lesion Classification", width="300", height="5", bg='pink', font=("Calibri", 16)).pack()
